...
import CFILessonRequestsWithTickets from '../components/CFILessonRequestsWithTickets';
  ...
  useEffect(() => {
    if (cfiId) {
      ...
      const channel = LessonRequestDeliverySystem.subscribeToRequests(cfiId, (payload) => {
        ...
        Alert.alert('New Lesson Request', 'You have a new lesson request ticket to review!');
      });
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.nameText}>Lesson Request Tickets</Text>
        </View>
        <CFILessonRequestsWithTickets cfiId={cfiId} />
      </View>
    );
  }
...
export default function CFIDashboardWithTickets() {
  return (
    <CFIProfileChecker>
      <CFIDashboardContent />
    </CFIProfileChecker>
