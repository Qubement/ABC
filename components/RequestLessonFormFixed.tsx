...
export default function RequestLessonFormFixed() {
  ...
  const loadAvailableDates = async () => {
    ...
    setAvailableAircraft([{id: '1', name: 'N123AB'}, {id: '2', name: 'N456CD'}]);
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setVerificationStatus('Lesson request created. Generating ticket...');
      
      const ticketResult = await TicketService.generateAndStoreTicket(data);
