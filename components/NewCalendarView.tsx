        ...
        {getDaysInMonth().map((day, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              onPress={() => day && onDateSelect(getDateString(day))}
              disabled={!day}
            >
              {day && (
...
const styles = StyleSheet.create({
  ...
  monthHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, paddingHorizontal: 16, paddingTop: 16 },
